...
class Report extends CI_Controller {
	...
	{
		$data['menu'] = 'report';
		$data['sub_menu'] = 'report_setting';
		$data['setting'] = $this->Report_Model->findSetting();
		$this->load->view("/admin/_header");
		$this->load->view("/admin/_left", $data);
		$this->load->view("/admin/report_setting", $data);	
	...
	public function setting_do()
	{
		...
		$first_ids = $this->input->post("first_ids");	
		$foot_ids = $this->input->post("foot_ids");	

		$this->Report_Model->update_setting($id, $first_ids, $foot_ids);

		redirect("/admin/report/setting");
	}
	...
	public function index()
	{
		...
		$reports = $this->Report_Model->findbackAll($offset, $limit);
		$data['menu'] = 'report';
