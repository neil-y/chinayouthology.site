...
class Register extends CI_Controller {
	...
	public function index()
	{
		...
		$count = $this->Register_Model->findCount($type_id);

		$data['num'] = $num;
		$data['type_id'] = $type_id;
		//分页配置
		$config['base_url'] = 'index.php?d=admin&c=register&m=index';
		if(!empty($type_id))
		{
			$config['base_url'] = 'index.php?d=admin&c=register&m=index&type=' . $type_id;
		}
		...
		$registers = $this->Register_Model->findAll($type_id, $offset, $limit);
