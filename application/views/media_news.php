	            ...
	            <div class="mod3">
			    	...
			    	<div class="sub-news new-cont bd cf">
			    		<div class="new-zy">
				    			...
				    			<div class="top-news">
								<h2><a title="<?php echo $news['title'];?>" href="/news/mdshow/<?php echo $news['id'];?>"><?php echo $news['title'];?></a></h2>
								<div class="new-zycont"><?php echo mb_strimwidth($news['outline'], 0, 265, "...", "utf8");?><span>[2013-5-27 9:59:24]</span> <a class="gary" title="<?php echo $news['title'];?>" href="/news/mdshow/<?php echo $news['id'];?>">全文</a> 
						            </div>
					            </div>
				            </div>
				            <ul style="margin-top:6px;" class="news-list">
										...
										{
											?>
											<li><span><?php echo $news['post_time'];?></span><a title="<?php echo $news['title'];?>" target="_blank" href="/news/mdshow/<?php echo $news['id'];?>"><?php echo $news['title'];?></a></li>
											<?php
										}
										$i++;
									}
