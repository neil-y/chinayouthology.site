		...
		<div class="container-wrap cf">
			...
			<section class="grid-1 fl">
				<div class="topmenu">
					<dl>
						<dt>民泰贵金属</dt>
						<dd <?php if($sub == "13") echo "class='active'"; ?> ><a href="/item/show/mintai_important">重要公告</a></dd>
						<dd <?php if($sub == "387") echo "class='active'"; ?> ><a href="/item/show/mintai_mianze">免责声明</a></dd>
						<dd <?php if($sub == "388") echo "class='active'"; ?> ><a href="/item/show/mintai_contact">联系我们</a></dd>
						<dd <?php if($sub == "389") echo "class='active'"; ?> ><a href="/item/show/mintai_secret">隐私保护条款</a></dd>
					</dl>
				</div>
			...
			<section class="grid-4 fr">
				...
				<div class="crumbs">
					本页位置：<a href="/">首页</a><span>&gt;&gt;</span><a href="/item/show/mintai_important">民泰贵金属</a><span>&gt;&gt;</span><?php echo $article['typename'];?>
	            </div>
	            ...
	            <div class="details-wrap">
					...
					<?php 
						...
						{
							?>
								<p>上一篇：<a href="/news/mintai_show/<?php echo $pre['id'];?>"><?php echo $pre['title']?></a></p>
					...
					<?php 
						...
						{
							?>
								<p>下一篇：<a href="/news/mintai_show/<?php echo $next['id'];?>"><?php echo $next['title']?></a></p>
