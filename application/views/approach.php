...
<!-- single header -->
		...
		<div id="container" class="cf">
			...
			<div class="approach">
				<h2>Brands need Inspiration <br />Provocative insights reveal the direction that lead brands to relevance</h2>
				<p>With today's fast-moving cultural landscape, brands are finding it harder to know what direction to take. Validation doesn't help when the brand's problem is first identifying the direction. What Brands need is Inspiration.</p>	
				<p>China Youthology goes into the lives of youth, those who are actively creating new meanings in their lives and shaping the important values of the next generation. We dig out the most provocative insights from today's youth with one sole purpose: to give brands accurate Inspiration so they can uncover the right direction forward.</p>	
			</div><!-- /approach -->

			<div class="approach-info cf">
				<div class="approach-imgwrap mosaic-block1 css3">				
					<div class="mosaic-block bar2">
						<a href="#inlineContent1" class="popup-inline mosaic-overlay">
							<div class="details">
								<p><span style="font-size:18px;">Youth Insider </span><br/><span style="text-decoration:underline;font-style:oblique;">more</span></p>
								<p>TRUSTABLE INSIGHTS FROM A YOUTH INSIDER</p>
							</div>
						</a>
						<div class="mosaic-backdrop">
							<div class="approach-pic"><img class="css3" src="/resources/front/images/approach/pic-approach1.jpg" alt="approach1" /></div>
						</div>							    		
			    	</div>
			    </div>
			    <div class="approach-imgwrap mosaic-block2 css3">
			    	<div class="mosaic-block bar2">
						<a href="#inlineContent2" class="popup-inline mosaic-overlay">
							<div class="details">
								<p><span style="font-size:18px;">Cultural Perspective</span><br/> <span style="text-decoration:underline;font-style:oblique;">more</span> </p>
								<p>A CULTURAL PERSPECTIVE TO REVEAL DISTINCTIVE OPPORTUNITIES</p>
							</div>
						</a>
						<div class="mosaic-backdrop">
							<div class="approach-pic"><img class="css3" src="/resources/front/images/approach/pic-approach2.jpg" alt="approach2" /></div>
						</div>								    		
			    	</div>
			    </div>
			    <div class="approach-imgwrap mosaic-block3 css3">
			    	<div class="mosaic-block bar2">
						<a href="#inlineContent3" class="popup-inline mosaic-overlay">
							<div class="details">
								<p><span style="font-size:18px;">Creative Collaboration</span><br/> <span style="text-decoration:underline;font-style:oblique;">more</span></p>
								<p>AMPLIFY IMPACT OF INSTIGHTS BY FACILITATING THE USAGE OF INSIGHTS</p>
							</div>
						</a>
						<div class="mosaic-backdrop">
							<div class="approach-pic"><img class="css3" src="/resources/front/images/approach/pic-approach3.jpg" alt="approach3" /></div>
						</div>								    		
			    	</div>
		    	</div>		
			</div><!-- /approach info -->
...
<div class="hidden">
	<div id="inlineContent1" class="inline-content">
		<h2>Trustable insights from a youth insider</h2>
		<p style="float:right; padding-left:10px;padding-right:10px;"><img src="/resources/front/images/approach/pic-approach1.jpg" alt="approach1" /></p>
		...
		For more, go to <a target="_blank" href="/about">About Us &gt;&gt;</a></p>
		...
		<ul>	
			<li><a href="/insights">Go to our Insights Center &gt;&gt;</a></li>
		</ul>
	</div>
</div>
<div class="hidden">
	<div id="inlineContent2" class="inline-content">
		<h2>A cultural perspective reveals distinctive opportunities</h2>
		<p style="float:right; padding-left:10px;padding-right:10px;"><img src="/resources/front/images/approach/pic-approach2.jpg" alt="approach1" /></p>
		<h3>Why?</h3>
		...
		<ul>
			...
			<!-- <li><img src="/resources/front/images/approach/pic-approach2-1.jpg" alt="pic-approach" /></li> -->
		</ul>
		...
		<h3>How?</h3>
		<h4>1. Anthropological perspective – We dive deep into the exploration and interpretation of nuanced meanings and practices</h4>
		<ul>
...
<div class="hidden">
	<div id="inlineContent3" class="inline-content">
		<h2>Amplify impact of insights by facilitating the usage of insights</h2>
		<p style="float:right; padding-left:10px;padding-right:10px;"><img style="max-width:400px;" src="/resources/front/images/approach/pic-approach3.jpg" alt="approach3" /></p>
