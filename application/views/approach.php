...
<!-- single header -->
		...
		<div id="container" class="cf">
			...
			<div class="approach">
				<h2>Brands need Inspiration. Provocative insights reveal the direction that leads brands to relevance.</h2>
				<p>With today's fast-moving cultural landscape, brands are finding it harder to know what direction to take. Validation doesn't help when the brand's problem is first identifying the direction.</p>	
				<p>What Brands need is Inspiration.</p>	
				...
				<div class="approach-imgwrap mosaic-block1 css3">				
					<div class="mosaic-block bar2">
						<a href="#inlineContent1" class="popup-inline mosaic-overlay">
							<div class="details">
								<p>Can I trust your insights<br />and inspiration? </p>
								<p>Trustable insights from a youth insider.</p>
								<p>Why a youth insider?</p>
								<p>Through us, your eyes are in the neighbourhood, <br /> not surveying from a helicopter.</p>
							</div>
						</a>
			    ...
			    <div class="approach-imgwrap mosaic-block2 css3">
			    	<div class="mosaic-block bar2">
						<a href="#inlineContent2" class="popup-inline mosaic-overlay">
							<div class="details">
								<p>Why do I need to<br />think 'culturally'? </p>
								<p>A cultural perspective reveals distinctive opportunities.</p>
								<p>Why?</p>
								<p>1. Not the traditional psychological<br />territories</p>
							</div>
						</a>
						<div class="mosaic-backdrop">
			    ...
			    <div class="approach-imgwrap mosaic-block3 css3">
			    	<div class="mosaic-block bar2">
						<a href="#inlineContent3" class="popup-inline mosaic-overlay">
							<div class="details">
								<p>How do you ensure your insights are impactful<br />to me? </p>
								<p>Amplify impact of insights by facilitating the usage of insights.</p>
								<dl>
									<dt>Why facilitate?</dt>
									<dd>Speed up insight internalization </dd>
								</p>
							</div>
						</a>
						<div class="mosaic-backdrop">
...
<div class="hidden">
	<div id="inlineContent2" class="inline-content">
		...
		<ul>
			...
			<li><img src="images/approach/pic-approach2-1.jpg" alt="pic-approach" /></li>
		</ul>
