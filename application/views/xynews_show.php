	...
	<div id="container" class="gridsystem cf">
		<div class="container-wrap cf">
			...
			<section class="grid-4 fr">
				<div class="subbanner">
					<img class="top_img" src="/resources/template/images/guijinshuxueyuan.jpg" alt="媒体报道" />
				</div>
	            ...
	            <div class="details-wrap">
					...
					<?php 
						...
						{
							?>
								<p>上一篇：<a href="/news/xyshow/<?php echo $pre['id'];?>"><?php echo $pre['title']?></a></p>
					...
					<?php 
						...
						{
							?>
								<p>下一篇：<a href="/news/xyshow/<?php echo $next['id'];?>"><?php echo $next['title']?></a></p>
